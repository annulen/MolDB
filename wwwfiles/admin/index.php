<?php
// admin/index.php    Norbert Haider, University of Vienna, 2009-2010
// part of MolDB5R    last change: 2010-06-10
...
$trusted    = is_trustedIP($ip);            // IP of MolDB5R admin
...
echo "On this page, you can add new MolDB5R data collections and edit existing ones.<br />\n";
echo "<hr />\n";
...
if (($db_id > 0) && ($action == "update")) {
  ...
  if ($newtype == "RD") {$ntype = 2; }   // new in MolDB5R
  $naccess = 1;
